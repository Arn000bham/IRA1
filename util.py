...
def rotateQuaternion(q_orig, yaw):
    ...
    # Multiply the new (heading-only) quaternion by the existing (pitch and bank) quaternion.
    # Order is important! The original orientation is the second argument, and the rotation to be applied is the first argument.
